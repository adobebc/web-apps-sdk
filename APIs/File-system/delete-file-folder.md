...
| version | draft | If the resource is a file and the file is a page:

if the page has a draft than the draft will be deleted

if the page does not have a draft, than nothing will get deleted

if it is a folder or not a page, than it will be ignored
